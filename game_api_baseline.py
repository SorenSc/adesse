...
connector = game_simulator.GameToSimulatorConnector(False)


@app.get("/step/")
def step(run_id=0, action_x=0, action_y=0, scenario='A', idx=629, taxi_x=14, taxi_y=10):
...
if __name__ == "__main__":
    uvicorn.run("game_api:app", host="127.0.0.1", port=5001, log_level="info")
